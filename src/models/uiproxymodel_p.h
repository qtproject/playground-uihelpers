...
#ifndef UIPROXYMODEL_P_H
#define UIPROXYMODEL_P_H
...
class UIProxyModelPrivate : private QAbstractItemModelPrivate
{
    Q_DECLARE_PUBLIC(UIProxyModel)
...
public:
    ...
    UIProxyModelPrivate() : QAbstractItemModelPrivate(), model(0) {}
